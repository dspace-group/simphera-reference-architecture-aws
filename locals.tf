...
locals {
  ...
  gpuPostUserData = "yum -y install make gcc\ndnf -y install kernel-devel-$(uname -r) kernel-headers-$(uname -r) kernel-modules-extra-$(uname -r)\ncurl -fSsl -O https://us.download.nvidia.com/tesla/550.54.14/NVIDIA-Linux-x86_64-550.54.14.run\nchmod +x NVIDIA-Linux-x86_64-550.54.14.run\nsh ./NVIDIA-Linux-x86_64-550.54.14.run -s --no-dkms --install-libglvnd"
  ...
  gpu_node_pool = {
    "gpuexecnodes" = {
      ...
      custom_ami_id          = "ami-03bd1d16f4bc2fdbf"
