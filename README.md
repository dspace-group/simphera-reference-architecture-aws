...
| <a name="output_database_endpoints_map"></a> [database\_endpoints\_map](#output\_database\_endpoints\_map) | Identifiers of the SIMPHERA and Keycloak databases from all SIMPHERA instances. |
