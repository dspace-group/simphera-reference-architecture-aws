...
| <a name="input_enable_nginx_metrics"></a> [enable\_nginx\_metrics](#input\_enable\_nginx\_metrics) | Switch to enable the metrics in the nginx values | `bool` | `false` | no |
